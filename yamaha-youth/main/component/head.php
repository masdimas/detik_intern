<head>
    ...
    <title>Classy Yamaha Youth Festival</title>

    <!-- BROWSER ICON -->
    <link rel="apple-touch-icon" sizes="180x180" href="./assets/images/favicon_io (1)/apple-touch-icon.png">
    ...
    <link rel="stylesheet" href="./assets/css/social-media-share.css" />
