...
<!-- Default State -->
<div class="row  gap-sm-3 gap-2 w-100">
...
<div class="row  gap-sm-3 gap-2 w-100">
            ...
            <div class="vote-miss-classy-card d-flex flex-column align-items-center col-6 ">
                ...
                <div class="w-100">
                    ...
                    <button class="vote-button rounded-pill mt-2 d-flex align-items-center justify-content-center gap-2 voted">
...
<div class="row  gap-sm-3 gap-2 w-100">
            ...
            <div class="vote-miss-classy-card d-flex flex-column align-items-center col-6 ">
                ...
                <div class="w-100">
                    <div class="d-flex flex-column align-items-center gap-1 mt-2">
                        <h4 class="candidate-name">Ini Pake Modal Mazzeh</h4>
                        <span class="candidate-school">SMAN 2 Bandung</span>
                    </div>
                    <button class="vote-button rounded-pill mt-2" data-bs-toggle="modal" data-bs-target="#exampleModal">VOTE</button>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content p-3">
                            ...
                            <div class="modal-footer">
                                <button class="mx-auto modal-cta rounded-pill">Masuk</button>
                            </div>
                        </div>
                    </div>
                    </div>
