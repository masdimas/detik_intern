            ...
            <div class="swiper mySwiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <a href="{clickurl}">
                            <img class="img-fluid d-none d-sm-block" src="./src/image/home/banner/banner-1.png" alt="">
                            <img class="img-fluid d-block d-sm-none" src="./src/image/home/banner/banner-mobile-1.png" alt="">
                        </a>
                    </div>
                    <div class="swiper-slide">
                        <a href="{clickurl}">
