...
<div id="accordion-open-brand-awardlist" data-accordion="open" class="shadow-[0px_0px_4px_4px_rgba(3,0,0,0)] shadow-[#8b896c] rounded-xl">
    ...
    <div id="accordion-open-brand-awardlist-body-1" class="hidden" aria-labelledby="accordion-open-brand-awardlist-heading-1">
    ...
    <div id="accordion-open-brand-awardlist-body-2" class="hidden" aria-labelledby="accordion-open-brand-awardlist-heading-2">
        <div class="pt-0 pb-[1.25rem] px-[1.25rem] bg-[#1a1527]">
            <p class="mb-2 text-white text-[17px] leading-[21px] font-light">This is the first item's accordion body. It is shown by default, until the collapse plugin adds the appropriate classes that we use to style each element.</p>
        </div>
    </div>
    ...
    <div id="accordion-open-brand-awardlist-body-3" class="hidden" aria-labelledby="accordion-open-brand-awardlist-heading-3">
        <div class="pt-0 pb-[1.25rem] px-[1.25rem] bg-[#1a1527]">
            <p class="mb-2 text-white text-[17px] leading-[21px] font-light">This is the first item's accordion body. It is shown by default, until the collapse plugin adds the appropriate classes that we use to style each element.</p>
        </div>
    </div>
    ...
    <div id="accordion-open-brand-awardlist-body-4" class="hidden" aria-labelledby="accordion-open-brand-awardlist-heading-4">
